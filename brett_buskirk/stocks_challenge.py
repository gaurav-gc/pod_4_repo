...
savings = int(input("What is your savings amount (as an integer)? "))
...
if company == "unknown":
  print(f'Sorry, {name}, {stock} is an unknown stock...')
else:
  # Alex has $5000 in savings and he can buy 50 shares of Apple at the current price of $100.
  print(f'{name} has ${savings} in savings and he can buy {totals} of {company} at the current price of {share_price}')
