...
'''
# define a function that receives a list as a parameter and returns the length of that list
...
'''
# define a function that plays a song from a list based on its track number
def play_track(playlist, track = 1):
	# print out info about the song played
	print(f"Now playing track {track}, {playlist[track - 1]['title']} by {playlist[track - 1]['artist']}")
	# increase the number of plays for that song in its dictionary
