...
print(f"The value of d ({d}) is False since 'not 8 < 20' is false, so both comprisons in the AND statement are not True.")
...
print (f"The value of o ({o}) is True since Python is case-sensitive and these strings are not equal.")
