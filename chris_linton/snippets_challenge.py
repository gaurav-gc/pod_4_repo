...
print(f'This sets d to {d} because one of the comparisons in the AND statement is False (not 8 < 20) making the whole thing False.')
...
print (f"The value of o ({o}) is True since Python is case-sensitive making m ({m}) and n ({n}) not equal.")
