...
# splitting string movies_str into a list of strings by the seperator ","
remaining_50_list = movies_str.split(",")
# Note: Print your new variable to see the list of movies
# printing list remaining_50_list
