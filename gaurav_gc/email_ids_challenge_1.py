...
print(joined_names)
'''
1) We need to use the variable names_list
2) We need to use the method 'join'
3) We know that the 'join' method can only be used on strings
4) Lists cannot call the 'join' method

Goal: "Ash Raman" --> ash.raman@ripplemedia.com
'''
