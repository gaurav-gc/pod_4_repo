...
print(
    f"1. You can visit {laptops[0]['url']} to see all the options of an {laptops[0]['productName']}.\n")
...
colors_str = str.join("\n", colors)
print(
    f"3. You can get the {laptops[1]['productName']} in the following two colors:\n{colors_str}\n")
