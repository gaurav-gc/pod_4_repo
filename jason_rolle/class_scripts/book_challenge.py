...
my_library.add(title='The Jim Crow',author='Michelle Alexander')
...
print('\nPart 5\n')
#assigning nyt bestsellers as an object of booklist
nyt_bestsellers=Booklist()
nyt_bestsellers.add( 'The Wish', 'Nicholas Sparks')
nyt_bestsellers.add( 'Apples Never Fall', 'Liane Moriaty')
