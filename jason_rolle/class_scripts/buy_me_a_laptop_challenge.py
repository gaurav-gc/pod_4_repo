...
print(laptops[0]["types"][0] ["price"], laptops[0]["types"][1]["price"])


# TODO: Write code to print all the color options for Dell XPS 13.
print(laptops[1]["types"][0] ["colors"], laptops[1]["types"][1]["colors"])
...
print(laptops[0]["types"][0] ["price"], laptops[0]["types"][1]["price"], laptops[1]["types"][0] ["price"], laptops[1]["types"][1]["price"])
