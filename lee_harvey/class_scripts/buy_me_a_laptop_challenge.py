...
print(f"1. You can visit {laptops[0]['url']} to see all the options of an {laptops[0]['productName']}.\n")

# TODO: Write code to print all possible prices of the 16-inch MacBook Pro.
prices = laptops[0]['types'][0]['price']
prices.extend(laptops[0]['types'][1]['price'])
print(f"2. You can pick up one of these {laptops[0]['productName']} for one of the following amounts, \
depending on CPU, RAM and Storage options.")
for amt in prices:
    print(amt, end=" ")
print("\n")

# TODO: Write code to print all the color options for Dell XPS 13.
colors = [laptops[1]['types'][0]['colors'][0]]
colors.append(laptops[1]['types'][1]['colors'][0])
colors_str = str.join("\n", colors)
print(f"3. You can get the {laptops[1]['productName']} in the following two colors:\n{colors_str}\n")
