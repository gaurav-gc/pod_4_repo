...
names = [x.lower() for x in ['Max Bartlett', 'Angelita Norris', 'Stewart Mueller', 'Dominique Henry', 'Carmela Gross', 'Bettie Mcmillan', 'Sara Ellison', 'Ira Anthony', 'Pauline Riley', 'Ben Weber',
...
print(names)
names = [x + "@ripplemedia.com" for x in names]
print(names)
