...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is at {self.location}.')
        print(f'These subway lines stop at {self.station_name}:')
        print(self.lines)
...
class BusStation(Station):
    ...
    def show_info(self):
        print(f'{self.station_name} station is located at {self.location}.')
        print(f'From this station, you can take a bus to the following places:')
        print(self.routes)
        if self.open:
